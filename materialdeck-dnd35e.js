...
const data = {
    systemId: 'dnd35e',
    moduleId: 'materialdeck-dnd35e',
    systemName: 'Dungeons & Dragons 3.5e'
}
...
class system {
    ...
    getItems(token,itemType) {
        ...
        else if (itemType == 'container') return allItems.filter(i => i.type == 'loot' && this.getItemData(i).subType == itemType);
        else {
